...
- Without 'xlim', the datasets is started at different time. 

- Reduce the value of 'alpha' in 'geom_rect', the graphs of rates are not continue anymore in visualization since the rectangles and the trends are overlapping.

- Size paramerter is useless and barely noticable.
